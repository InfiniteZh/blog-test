...
const config = hexo.config.gptsummary
hexo.extend.filter.register('after_post_render', async function (data) {
    if(config.default_enable)data.gptsummary = data.gptsummary || true
    if(!data.gptsummary || data.excerpt || data.description)return data
